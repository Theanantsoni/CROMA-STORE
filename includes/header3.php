        ...
        $(document).ready(function() {
            $('#searchInput').on('input', function() {
                ...
                $('.product-container').each(function() {
                    ...
                    // If the product name contains the search text, show it; otherwise, hide it
    ...
    <div class="container-fluid pt-5" id="products">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            while ($data = mysqli_fetch_array($result)) {
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1 product-container" data-productname="<?php echo strtolower($data['productname']); ?>">
